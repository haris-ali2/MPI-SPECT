...
% Fusion
\node[block, below=of encoder] (fusion) {Feature Fusion \\ (nnFormer Features $\oplus$ Shape Priors)};
...
% \node[legendbox] at ([xshift=3cm,yshift=-6cm]current bounding box.west) {
%     \begin{tabular}{@{}l@{\ }l@{}}
%         \textcolor{blue}{\rule{5mm}{1mm}} & Main Network Path \\
%         \textcolor{red}{\rule{5mm}{1mm}} & Shape Prior Components \\
%         \textcolor{black}{\rule{5mm}{1mm}\textsuperscript{---}} & Skip Connections \\
